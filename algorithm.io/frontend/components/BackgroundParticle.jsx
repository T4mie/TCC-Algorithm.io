...
// Renderiza o fundo animado de partículas (ícones de SLL e Vetor flutuando
// pela tela). Responsável apenas por inicializar o motor de partículas e
// exibi-lo como uma camada decorativa atrás do conteúdo principal.
const BackgroundParticles = () => {
  ...
  // Callback exigido pela lib de partículas quando o container termina de carregar
